...
export default function Paint() {
  ...
  return (
    <div className="flex flex-col h-screen bg-[#f3f3f3] select-none font-['Segoe_UI',system-ui,sans-serif]">

      {/* Top Menu Bar */}
      <div className="bg-white border-b border-gray-300 px-3 py-1 flex items-center gap-3">
      ...
      <div className="flex-1 flex items-center justify-center overflow-auto bg-[#e5e5e5] p-8">
