      ...
      {quickSettingsOpen && (
        ...
        <>
          ...
          <motion.div
            ...
            className={
              isMobile
                ? 'fixed inset-x-0 bottom-0 z-50 w-full max-h-[70vh] overflow-hidden rounded-t-2xl origin-bottom shadow-2xl ring-1 ring-gray-200'
                : 'fixed bottom-14 right-4 z-50 w-[360px] overflow-hidden rounded-2xl origin-bottom-right shadow-2xl ring-1 ring-gray-200'
            }
          ...
          >
            ...
            <div className={`p-4 sm:p-6 pb-2 grid gap-3 ${isMobile ? 'grid-cols-2' : 'grid-cols-3'}`}>
